...
const Discover = () => {
  useGSAP(() => {
    gsap.from(".property_title", {
      opacity: 0,
      y: 100,
      duration: 1,
      ease: "power4.out",
      scrollTrigger: {
        trigger: ".property_title",
        start: "top 90%",
        end: "bottom 20%",
        scrub: true,
      },
    });
    gsap.from(".property_card", {
      opacity: 0,
      y: 100,
      duration: 1,
      ease: "power4.out",
      stagger: 0.2,
      scrollTrigger: {
        trigger: ".property_card",
        start: "top 90%",
        end: "bottom 80%",
        scrub: true,
      },
    });
    gsap.from(".property_pagination", {
      opacity: 0,
      duration: 3,
      ease: "power4.out",
      scrollTrigger: {
        trigger: ".property_pagination",
        start: "top 90%",
        end: "bottom 20%",
        scrub: true,
      },
  ...
  return (
    <section id="portfolio">
      <div className="container mx-auto flex flex-col justify-between md:pb-[150px] sm:pb-[100px] pb-[50px] px-[25px]  gap-[80px]">
        ...
        >
          {homeFeatureds.map((item, index) => (
            <div
              key={index}
              className={clsx(
                "border-[1px] border-grey15 w-full rounded-[10px] space-y-[30px] 2xl:p-10 lg:p-[25px] md:p-[20px] p-[15px] overflow-hidden property_card",
            ...
            >
              ...
              <div className="flex flex-col xl:flex-row items-center justify-center md:justify-between 2xl:gap-[50px] xl:gap-[10px] lg:gap-[5px] md:gap-[20px] sm:gap-[15px] gap-[20px]">
                ...
                <Button2
                  className={clsx("lg:text-[12px] lg:px-[10px] lg:py-[12px]")}
        ...
        {/* pagination */}
        <div className="flex items-center justify-between border-t-[1px] border-grey15 py-8 px-6 property_pagination">
